...
export default function SingleNewsPage({ post }) {
  ...
  return (
    <div className="min-h-screen  flex flex-col items-center justify-start">
      <div className="min-h-[33vh] md:h-[50vh]  w-full relative bg-gradient-to-t bg-secondary">
        <div className="absolute top-0 w-full h-full flex flex-col justify-center ">
          <div className="px-4 md:px-24 max-w-screen-2xl mx-auto w-full">
            <h1 className="text-center text-2xl md:text-6xl text-white font-bold underline md:decoration-8 decoration-primary">
              {title}
            </h1>
          </div>
        </div>
